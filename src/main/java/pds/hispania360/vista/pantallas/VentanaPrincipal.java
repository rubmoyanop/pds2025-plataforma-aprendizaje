...
public class VentanaPrincipal implements Ventana {
    ...
    private JPanel crearSeccionHero() {
        ...
        // Título principal con sombra para dar profundidad
        JLabel labelTitulo = new JLabel("<html><div style='text-shadow: 1px 1px 2px rgba(0,0,0,0.2);'>Descubre la Historia de España</div></html>");
        labelTitulo.setFont(new Font("Segoe UI", Font.BOLD, 44)); // Fuente más grande
        labelTitulo.setForeground(EstilosApp.COLOR_PRIMARIO);
        labelTitulo.setAlignmentX(Component.LEFT_ALIGNMENT);
        
        // Subtítulo con mejor formato y espaciado
        JTextArea areaDescripcion = new JTextArea(
            "Aprende de forma interactiva y amena sobre los acontecimientos " +
            "y personajes que han dado forma a la historia de España desde la prehistoria " +
            "hasta nuestros días."
        );
        ...
        areaDescripcion.setForeground(new Color(60, 60, 70)); // Color más oscuro para mejor contraste
